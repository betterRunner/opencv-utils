...
//    double viz_factor)
//    {
//    Mat visual_image(Size(origImg.cols*scaleFactor,origImg.rows*scaleFactor), origImg.type(), Scalar::all(0));
...
//hog.winSize=Size(3,3);
//hog.blockSize=Size(3,3);
//hog.cellSize=Size(3,3);
//    vector<float> des;
...
int main()
{
    ...
    */
    ...
    Mat src = imread("guy5.jpeg");//注意这里边的双斜杠！！！！！！！！！！
		resize(src, src, Size(64*2,128*2));
    ...
    Mat d = get_hogdescriptor_visual_image(src,des,hog.winSize,hog.cellSize,3,2.5);
    imshow("dst",d);
